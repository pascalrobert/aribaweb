...
public class Fmt
{
    ...
    */
    public static String Sil (
        ...
        Object a5)
    {
        return Sil(locale, stringTable, key, a1, a2, a3, a4, a5, null, null);
    }
    ...
    */
    public static String Sil (
        ...
        Object a6)
    {
        return Sil(locale, stringTable, key, a1, a2, a3, a4, a5, a6, null);
    }
    ...
    */
    ...
    {
        Object[] args = argsArray(a1, a2, a3, a4, a5, a6, more);
        return Sil(locale, stringTable, key, args);
    }
    ...
    /**
        ...
        @aribaapi documented
    */
    public static String Sil (Locale locale, String stringTable,
                              String key, List vectorArgs)
    {
        Object [] args = vectorArgs.toArray();
        return Sil(locale, stringTable, key, args);
    }
    ...
    */
    ...
    {
        String control =
            ResourceService.getService().getLocalizedString(stringTable, key, locale);
        return Si(control, args);
    }
    ...
    */
    ...
    /**
        ...
        @aribaapi documented
    */
    public static String Si (String control, List vectorArgs)
    {
        Object [] args = vectorArgs.toArray();
        return Si(control, args);
    }
    ...
    */
    ...
    /**
        @param value a string whose single quotes need escaping.
        @return the given string value with internal
    ...
    */
    ...
    /**
        In our codebase AQL queries are constructed using <code>Fmt.S</code> where a
        ...
        @param value the un-quoted string value
        @return the quoted string value. The single quotes inside <code>value</code> are
                also escaped.
